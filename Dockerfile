...
COPY --chmod=o+wrX . /workspaces/fastcs-goniowl
WORKDIR /workspaces/fastcs-goniowl
...
RUN git remote set-url origin git@github.com:DiamondLightSource/fastcs-goniowl.git
